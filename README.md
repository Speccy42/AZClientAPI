...
* Compatible avec les versions **1.8.***/**1.9.4** (voir la page [releases](https://github.com/Speccy42/AZClientAPI/releases)).
...
## Documentation
[Documentation et exemples sur le Wiki.](https://github.com/Speccy42/AZClientAPI/wiki)